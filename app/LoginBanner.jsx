...
class LoginBanner extends React.Component {
  ...
  checkExpiryHandler() {
    if (this.state.loginData) {
      ...
      const timeToGo = this.state.loginData.exp_raw()
        ? this.state.loginData.exp_raw() - nowTime
        : null;
      if (timeToGo && timeToGo >= 300) {
        ...
        return this.setStatePromise({
          expired: true,
          expiryWarning: false,
          expiredAt: this.state.loginData.exp_raw(),
        });
      }
    } else {
      ...
      <div className="login-banner">
        <div className="welcome">
          <p style={{ margin: 0, padding: 0 }}>
            Welcome {this.state.loginData.first_name()}{" "}
            {this.state.loginData.family_name()}
          </p>
          <p
          ...
          >
            ...
            {this.state.loginData.exp().tz("Europe/London").format("HH:mm")}{" "}
