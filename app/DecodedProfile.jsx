...
class DecodedProfile {
    constructor(fromData) {
        if(!fromData.hasOwnProperty("sub") || !fromData.hasOwnProperty("aud")) {
            console.error("Tried to initialise DecodedProfile from something that is not a user profile")
            throw TypeError;
        }
    ...
    first_name() {
        return this._content.hasOwnProperty("first_name") ? this._content.first_name : null;
    }
    family_name() {
        return this._content.hasOwnProperty("family_name") ? this._content.family_name : null;
    }
    username() {
        return this._content.hasOwnProperty("username") ? this._content.username : null;
    }
    location() {
        return this._content.hasOwnProperty("location") ? this._content.location : null;
    }
    job_title() {
        return this._content.hasOwnProperty("job_title") ? this._content.job_title : null;
    }
    authmethod() {
        return this._content.hasOwnProperty("authmethod") ? this._content.authmethod : null;
    }
    auth_time() {
        return this._content.hasOwnProperty("auth_time") ? this._content.auth_time : null;
    }
    ver() {
