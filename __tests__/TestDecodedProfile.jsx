...
describe("DecodedProfile", ()=>{
    it("should take information from a json object and present it nicely", ()=>{
        const rawdata = {"aud":"https://someservice.corp.int/callback",
            ...
            "auth_time":"2020-05-17T09:39:51.023Z","ver":"1.0","appid":"4BEDDDD2-BE69-4792-9C91-5708C43566D6"}
        ...
        expect(prof.iat().format("YYYY-MM-DD HH:mm:ss")).toEqual("2020-05-17 11:06:54");
        expect(prof.exp_raw()).toEqual(1589717214);
        expect(prof.exp().format("YYYY-MM-DD HH:mm:ss")).toEqual("2020-05-17 12:06:54");
